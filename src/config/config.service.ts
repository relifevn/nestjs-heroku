...
export class ConfigService {
	...
	constructor() {
		this.envConfig = {
			MONGODB_URL:
				'mongodb://thcshiepphuoc:thcshiepphuoc@18.222.144.236:21111/thcshiepphuoc',
	...
	get homeConfig() {
		return {
			...
			imageUrl:
				'https://khkt-thcs-hiep-phuoc-server.herokuapp.com/images/1.jpg',
