...
export class CenterService {
    ...
    public lastSentDrowsinessDetector: Date = new Date(new Date().getTime() - 10000000)
    ...
    private checkIsTimeToSendGmailDrows(): boolean {
        return new Date().getTime() - this.lastSentDrowsinessDetector.getTime() > this.DISTANCE_BETWEEN_EACH_NOTIFICATION
    }
